  ...
  <div class="home" style="padding: 10px">
    ...
    <div style="margin: 10px 0;">
      <el-form inline="true" size="small">
        ...
        <el-form-item v-if="user.role == 0" label="读者编号">
    ...
    <!--按钮-->
    <div style="margin: 10px 0;" v-if="user.role == 0">
    ...
    <el-table :data="tableData" stripe height="calc(100vh - 255px)" border="true"
      ...
      <el-table-column v-if="user.role === 0" label="操作" width="230px">
        <template v-slot="scope">
